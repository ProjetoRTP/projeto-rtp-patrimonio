...
from config.settings import DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASS, DB_DSN, BASE_DIR
import oracledb
import os
...
class Database:
    ...
    def initialize(cls):
        ...
        target_lib_dir = os.path.join(BASE_DIR, 'instant_client', 'instantclient_23_4')
